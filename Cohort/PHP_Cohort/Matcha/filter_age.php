    ...
    <div class="container" style="position: relative; top: 15%; height: 80%; color: whitesmoke; z-index: 2; overflow-y: scroll;">
    	<center>
	    	<form method="POST" action="">
	    		<input type="submit" name="btnage" value="18-25" class="btn btn-dark">
	    		<input type="submit" name="btnage" value="25-35" class="btn btn-dark">
	    		<input type="submit" name="btnage" value="35+" class="btn btn-dark">
	    	</form>
	    	<br>
    	</center>
    	<?php
